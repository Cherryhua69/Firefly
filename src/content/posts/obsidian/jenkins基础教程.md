...
description: "Jenkins Jenkins是一个开源软件项目,是基于Java开发的一种持续集成工具,用于监控持续重复的工作,旨在提供一个开放易用的软件平台,使软件项目可以进行持续集成 官方网站 https://www.jenkins.io/ 使用前相关软件安装准备: GitLab安装使用 官"
image: ""
tags: ["Docker"]
category: "运维部署"
draft: false
...
1. 1.
    ...
    //阿里镜像
    [https://mirrors.aliyun.com/docker-ce/linux/centos/gpg](https://mirrors.aliyun.com/docker-ce/linux/centos/gpg)
